...
switch solver_type
    ...
    case 'DynSys_Based'
        ...
        Solver_option.Continuation.epsilon_T = 0.5;
        Solver_option.Continuation.epsilon_p = 1;
        ...
        Solver_option.Continuation.tol.KKT_error = 5e-1;
        Solver_option.Continuation.tol.VI_nat_res = 5e-1;
