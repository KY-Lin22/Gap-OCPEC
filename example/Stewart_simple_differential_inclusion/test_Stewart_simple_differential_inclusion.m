...
switch solver_type
    ...
    case 'DynSys_Based'
        ...
        Solver_option.Continuation.epsilon_T = 10;
        ...
        Solver_option.Continuation.tol.KKT_error = 1e-3;
        Solver_option.Continuation.tol.VI_nat_res = 5e-2;
        Solver_option.KKT.RegParam.nu_h = 1e-6; 
        Solver_option.KKT.RegParam.nu_c = 1e-4; 
