...
OCPEC = OCPEC_Vieira_LCS_control_jump();

%% discretize OCPEC into a NLP problem
Option.relaxProbType = 'KKT_based'; % 'generalized_primal_gap_constraint_based', 
...
solver.Option.Homotopy.kappa_times = 0.2;
solver.Option.Homotopy.kappa_exp = 1.5;
...
%%
plotResult_Vieira_LCS_control_jump(OCPEC, NLP, z_Opt)
