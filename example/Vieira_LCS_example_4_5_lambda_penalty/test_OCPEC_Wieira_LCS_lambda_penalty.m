...
% create solver
solver_type = 'IPOPT_Based'; % 'IPOPT_Based', 'DynSys_Based'
switch solver_type
    case 'IPOPT_Based'
        ...
        Solver_option.Continuation.update_rule = 'dynamics'; % 'times_exp', 'dynamics'
        ...
        Solver_option.Continuation.dtau = 0.20;
        Solver_option.Continuation.l_Max = 25;
        Solver_option.Continuation.tol.VI_nat_res = 1e-6;
    ...
    case 'DynSys_Based'
        ...
        Solver_option.Continuation.s_Init = 1e0;
        Solver_option.Continuation.s_End = 1e-3;
        Solver_option.Continuation.epsilon_T = 50;
        Solver_option.Continuation.epsilon_s = 10;
...
%% show result
plotResult_Vieira_LCS_lambda_penalty(OCPEC, NLP, z_Opt)
