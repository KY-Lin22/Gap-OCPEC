...
NLP_reformulation_name = {...
    'Gap (primal, \epsilon = 1e-2)', 'Gap (primal, \epsilon = 1e-4)', 'Gap (primal, \epsilon = 1e-6)', 'Gap (primal, \epsilon = 0)',...
    'Gap (primal, pen, \epsilon = 1e-2)', 'Gap (primal, pen, \epsilon = 1e-4)', 'Gap (primal, pen, \epsilon = 1e-6)', 'Gap (primal, pen, \epsilon = 0)'};
