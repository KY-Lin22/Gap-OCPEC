...
NLP_option_set = {...
    ...
    'penalty_gap_func_auxiliary_variable', 'L2',...
    'gap_func_smooth_param', 0)};
NLP_reformulation_name = {'Gap (primal, 0.1)', 'Gap (primal, 0.01)', 'Gap (primal, 0.001)', 'Gap (primal, 0)',...
'Gap (primal, pen, 0.1)', 'Gap (primal, pen, 0.01)', 'Gap (primal, pen, 0.001)', 'Gap (primal, pen, 0)',};
