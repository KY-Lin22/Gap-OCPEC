...
C = SX(OCPEC.Dim.g + 1 + OCPEC.Dim.G, OCPEC.nStages);
...
c = reshape(C, (OCPEC.Dim.g + 1 + OCPEC.Dim.G) * OCPEC.nStages, 1);
...
Dim.c_Node = cumsum([OCPEC.Dim.g, 1, OCPEC.Dim.G]); % node point after reshaping c into stagewise C
