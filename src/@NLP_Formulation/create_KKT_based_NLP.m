...
H = [f_stage; KKT_stationarity_stage; g_stage - W; C_stage];
...
C = [KKT_complementarity_stage; G_stage];
c = reshape(C, (size(KKT_complementarity_stage, 1) + OCPEC.Dim.G) * OCPEC.nStages, 1);
