function nlp = create_primal_gap_NLP_w(self, OCPEC)
% formulate a relax generalized primal gap constraint based NLP using
% auxiliary variable w for primal gap function
%
% OCPEC has the form:
